...
namespace SimpleJSON
{
    ...
    public class JSONNode
    {
        ...
        public virtual long AsLong
        {
            ...
            {
                long v = 0;
                if (long.TryParse(Value,System.Globalization.NumberStyles.Any,System.Globalization.CultureInfo.InvariantCulture, out v))
                    return v;
                return 0;
            }
            set
        ...
        internal static StringBuilder Escape(string aText)
        {
        ...
        internal static JSONNode Parse(object text)
        {
    ...
    public class JSONArray : JSONNode, IEnumerable
    {
        ...
        public void RemoveRange(int startIndex, int length)
        {
            if (startIndex < 0 || startIndex >= m_List.Count)
                return;
            m_List.RemoveRange(startIndex, length);
        }
        ...
        public override string ToString(string aPrefix)
        {
            ...
            foreach (JSONNode N in m_List)
            {
                if (result.Length > 3)
                    result.Append(temp);
                result.Append('\n');
                result.Append(prefixSpace);            
                result.Append(N.ToString(prefixSpace));
            }
            result.Append('\n');
    ...
    public class JSONClass : JSONNode, IEnumerable
    {
        ...
        public Dictionary<string, JSONNode> GetKeyValues()
        {
            return m_Dict;
        }    
        ...
        public override JSONNode this[int aIndex]
        {
            get
            {
                ...
                throw new Exception("Json object not support this operation: get by index");
            }
            set
            {
                //if (aIndex < 0 || aIndex >= m_Dict.Count)
                ...
                //m_Dict[key] = value;
                throw new Exception("Json object not support this operation: set by index");
            }
        }
        public override int Count
        {
        ...
        public override string ToString(string aPrefix)
        {
            ...
            foreach (KeyValuePair<string, JSONNode> N in m_Dict)
            {
                ...
                result.Append(Escape(N.Key));
                result.Append(temp1);
                result.Append(N.Value.ToString(prefixSpace));
            }
            result.Append('\n');
            result.Append(aPrefix);
            result.Append('}');
